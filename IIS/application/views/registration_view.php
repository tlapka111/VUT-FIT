...
<div class="telo">
	...
	<form method="POST">
		<fieldset class="registration_form">
			<legend style="color: #0d0d0d">Registrace</legend>
			...
			<div class="form-group" style="width: 40vw">
				<label for="lastName" style="color: #0d0d0d">
					Příjmení
					<span class="required_elements"> *</span>
				</label>
			...
			<div class="form-group" style="width: 40vw">
				<label for="passwordAgain" style="color: #0d0d0d">
					Heslo znovu
					<span class="required_elements"> *</span>
				</label>
			...
			<br>
			<button style="margin-bottom: 3vw" class="btn btn-outline-primary registration_button" type="submit" id="register" name="register" disabled>Zaregistrovat se</button>
		</fieldset>
	</form>
